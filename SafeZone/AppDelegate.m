...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[UINavigationBar appearance] setBarTintColor:UIColorFromRGB(0x194A75)];
...
- (void)createCopyOfDatabaseIfNeeded {
    ...
    NSString *appDBPath = [documentsDirectory stringByAppendingPathComponent:@"safe_zones.sqlite"];
    ...
    NSString *defaultDBPath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"safe_zones.sqlite"];
